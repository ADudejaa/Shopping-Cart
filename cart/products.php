...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <img src="img/show6.png" style="postion:relative;margin-left:1%;height:30%;width:50%;"><img src="img/productslogo.jpeg" style="postion:relative;margin-right:1%;height:30%;width:35%;float:right ;">
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/core ui.jpeg" alt="Core UI">
                            <center>
                                <div class="caption">
                                    <h3>Core UI</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/advancedui.jpg" alt="Advanced UI">
                            <center>
                                <div class="caption">
                                    <h3>Advanced UI</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/angular.png" alt="Angular JS">
                            <center>
                                <div class="caption">
                                    <h3>Angular JS</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/react2.jpg" alt="React">
                            <center>
                                <div class="caption">
                                    <h3>React JS</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/java1.jpg" alt="Java">
                            <center>
                                <div class="caption">
                                    <h3>Java</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img/nodejs.jpg" alt="Node">
                            <center>
                                <div class="caption">
                                    <h3>NodeJS</h3>
